# RisingOS Installation Instructions for dubai

**Maintainer:** [Rakhshan Ali](https://t.me/ararchive_shan_rakh_discussion) | @Rakhshan7070

### Required Files

* Download the needed files from [download page](https://risingosrevived.tech/downloads.html?codename=dubai)

* Required device files for first-time flash:
  * boot.img
  * dtbo.img
  * vendor_boot.img
  * ...and then the latest OTA zip for dubai (RisingOS_Revived-x.x.x-xxxxxxxx-CORE-OFFICIAL-dubai-ota.zip)
...
``` 
adb sideload RisingOS_Revived-x.x.x-xxxxxxxx-CORE-OFFICIAL-dubai-ota.zip
```
